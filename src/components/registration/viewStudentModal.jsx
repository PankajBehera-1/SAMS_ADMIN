...
const ViewStudentModal = (props) => {
  const { openViewModal, handleCloseViewModal } = props;

  //   const ViewStudentDialog = (props) => {
  ...
  return (
    <>
      ...
      <Dialog open={openViewModal} onClose={handleCloseViewModal}>
        ...
        <Dialog open={openViewModal} onClose={handleCloseViewModal} fullScreen>
          ...
          <DialogContent sx={{ width: "600vw%", height: "100vh" }}>
            <Grid className={style.fullpage}>
              <Grid sx={{ marginLeft: "85vw" }}>
                <CloseIcon onClick={handleCloseViewModal} />
              </Grid>
                ...
                <Grid className={style.secondrows}>
                  ...
                  <Grid className={style.name}>
                    ...
                    <input
                      type="file"
                      accept="image/png, image/jpeg"
                      name="td_12th_certificate"
                      value={studentData.td_12th_certificate}
                      onChange={handleinputchange}
                    ></input>
                  </Grid>
                  ...
                  <Grid className={style.name}>
                    ...
                    <input
                      type="file"
                      accept="image/png, image/jpeg"
                      name="std_12th_markshee"
                      value={studentData.std_12th_markshee}
                      onChange={handleinputchange}
                    ></input>
                  </Grid>
                </Grid>
              ...
              <button type="submit" onClick={handleCloseViewModal}>
                Submit
              </button>
            </Grid>
          </DialogContent>
