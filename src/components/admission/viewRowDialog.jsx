...
const ViewRowDialog = (props) => {
  ...
  const handlePrint = () => {
    ...
    imageWindow.document.write('<img src="your_image_url_here" style="width:100%" />');
          ...
          <Grid className={style.fullpage}>
            ...
            <Grid className={style.firstPage}>
              ...
              <Grid className={style.avtarpic}>
                ...
                <h3 style={{marginLeft:"50%"}}>Image Preview</h3>
                  <img src="your_image_url_here" alt="Preview" onClick={handlePrint} style={{ cursor: 'pointer' }} />
            ...
            <Grid className={style.container}>
              ...
              <Grid className={style.secondrows}>
                ...
                <Grid className={style.name}>
                  ...
                  <h3>Image Preview</h3>
                  <img id="img" src="your_image_url_here" alt="Preview" onClick={handlePrint} style={{ cursor: 'pointer' }} />
                </Grid>
              </Grid>
              <Grid className={style.thirdcoloumn}></Grid>

            </Grid>
            <Grid container direction="row" lg={12} sx={{ mt: 3, }}>
              <Grid item lg={6} sx={{ display: "flex", justifyContent: "center" }}>
                <Button sx={{ backgroundColor: "green", color: "white" }} type="approve" onClick={handleCloseDialog}>
                  Approve
                </Button>
              </Grid>
              <Grid item lg={6} sx={{ display: "flex", justifyContent: "center" }}>
                <Button sx={{ backgroundColor: "Red", color: "white" }} type="reject" onClick={handleCloseDialog}>
                  Reject
                </Button>
              </Grid>
            </Grid>
