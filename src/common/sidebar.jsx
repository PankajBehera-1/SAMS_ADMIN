          ...
          {({ isActive }) => (
            <ListItem disablePadding>
              <ListItemButton
                className={
                  isActive
                    ? SidebarStyle.dashboard_active_link
                    : SidebarStyle.dashboard
                }
              >
                <ListItemIcon>
                  <DashboardIcon
          ...
          {({ isActive }) => (
            <ListItem disablePadding>
              <ListItemButton
                className={
                  isActive
                    ? SidebarStyle.addStudent_active_link
                    : SidebarStyle.addStudent
                }
              >
                <ListItemIcon>
                  <GroupAddIcon
          ...
          {({ isActive }) => (
            <ListItem disablePadding>
              <ListItemButton
                className={
                  isActive
                    ? SidebarStyle.addNotice_active_link
                    : SidebarStyle.addNotice
                }
              >
                <ListItemIcon>
                  <PostAddIcon
          ...
          {({ isActive }) => (
            <ListItem disablePadding>
              <ListItemButton
                className={
                  isActive
                    ? SidebarStyle.registration_active_link
                    : SidebarStyle.registration
                }
              >
                <ListItemIcon>
                  <DescriptionIcon
        ...
        >
          ...
          >
            <img
              src={AdminLogo}
              alt="Admin Logo"
              style={{ width: "25%", paddingTop: 10, marginLeft: 10 }}
            />
            <h2 style={{ paddingTop: 25, color: "white", letterSpacing: 10 }}>
              SAMS
            </h2>
          </Grid>
          {drawer}
